...
class SPA {
    ...
    private init(): void {
        // 페이지 섹션 요소 가져오기
        const sectionElements = document.querySelectorAll<HTMLElement>('.page-section');
        ...
        // 네비게이션 링크 요소 가져오기
        this.navLinks = Array.from(document.querySelectorAll<HTMLAnchorElement>('.spa-nav a, .spa-link'));
    ...
    private navigateToSection(sectionId: string): void {
        ...
        const activeNavLinks = this.navLinks.filter(link =>
